...
public class PhoneBook {
    ...
    private String[] names = new String[10000000];
    ...
    private void processQuery(Query query) {
        if(query.type.equals("add")){
            ...
            names[query.number] = null;
        }
        else{
            if(names[query.number] == null) writeResponse("not found");
            else writeResponse(names[query.number]);
        }
